...
import WmaSchedulesReport from './WmaSchedulesReport';
...
export default function ViewSchedules() {
  ...
  return (
    <WMADrawer>
      ...
      <div className="m-5 shadow-md rounded-lg">
        <div className="flex justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => setIsReportOpen(true)} className="bg-green-600 text-white px-3 py-2 rounded-md">Generate Report</button>
          </div>
          {/* <Button
            variant="contained"
            color="success"
              ...
              filteredSchedules
                ...
                .map((schedule) => (
                  ...
                  >
                    ...
                    >
                      {schedule.wmaId
                        ? schedule.wmaId.wmaname
                        : "No WMA assigned"}
                    </th>
                    <td className="px-5 py-4">
                      {schedule.collectorId
                        ? schedule.collectorId.collectorName
                        : "No collector assigned"}
                    </td>
                    <td className="px-5 py-4">
                      {schedule.area ? schedule.area.name : "No area assigned"}
                    </td>
                    ...
                    <td className="px-5 py-4"> {schedule.time}</td>
      ...
      {isReportOpen && (
        <WmaSchedulesReport
          schedules={filteredSchedules.length ? filteredSchedules : schedules}
